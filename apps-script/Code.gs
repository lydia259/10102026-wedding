...
function buildRsvpConfirmEmail_(c) {
  ...
  return [
    ...
    '  .signature{font-size:16px!important;}',
    ...
    '<div style="font-family:\'Inter\',-apple-system,BlinkMacSystemFont,\'Helvetica Neue\',Arial,sans-serif;font-weight:400;font-size:18px;color:#0f1a33;line-height:1.4;letter-spacing:.01em;" class="signature">Colin &amp; Lydia &amp; Zoomie</div>',
    '</td></tr>',
